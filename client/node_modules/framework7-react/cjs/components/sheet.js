...
var Sheet = /*#__PURE__*/(0, _react.forwardRef)(function (props, ref) {
  var _f7Sheet = (0, _react.useRef)(null);
  ...
  var onMount = function onMount() {
    ...
    (0, _f.f7ready)(function () {
      _f7Sheet.current = _f.f7.sheet.create(sheetParams);
  ...
  var classes = (0, _utils.classNames)(className, 'sheet-modal', "sheet-modal-" + positionComputed, {
