...
var Range = /*#__PURE__*/(0, _react.forwardRef)(function (props, ref) {
  var _f7Range = (0, _react.useRef)(null);
  ...
  var onMount = function onMount() {
    (0, _f.f7ready)(function () {
      ...
      _f7Range.current = _f.f7.range.create((0, _utils.noUndefinedProps)({
        el: elRef.current,
        value: value,
        min: min,
        max: max,
        ...
        on: {
          change: function change(range, val) {
            (0, _utils.emit)(props, 'rangeChange', val);
          },
          changed: function changed(range, val) {
            (0, _utils.emit)(props, 'rangeChanged', val);
          }
        }
      }));
    });
  ...
  var classes = (0, _utils.classNames)(className, 'range-slider', {
  ...
  return /*#__PURE__*/_react.default.createElement("div", _extends({
    ...
    style: style,
    className: classes
  }, extraAttrs), input && /*#__PURE__*/_react.default.createElement("input", {
    type: "range",
    name: name,
    id: inputId
  }), children);
