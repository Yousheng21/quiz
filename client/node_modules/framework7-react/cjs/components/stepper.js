...
var Stepper = /*#__PURE__*/(0, _react.forwardRef)(function (props, ref) {
  var _f7Stepper = (0, _react.useRef)(null);
  ...
  var onInput = function onInput(event) {
    (0, _utils.emit)(props, 'input', event, _f7Stepper.current);
  };

  var onChange = function onChange(event) {
    (0, _utils.emit)(props, 'change', event, _f7Stepper.current);
  };

  var onMinusClick = function onMinusClick(event) {
    (0, _utils.emit)(props, 'stepperMinusClick', event, _f7Stepper.current);
  };

  var onPlusClick = function onPlusClick(event) {
    (0, _utils.emit)(props, 'stepperPlusClick', event, _f7Stepper.current);
  };
  ...
  var onMount = function onMount() {
    (0, _f.f7ready)(function () {
      ...
      _f7Stepper.current = _f.f7.stepper.create((0, _utils.noUndefinedProps)({
        el: elRef.current,
        min: min,
        max: max,
        value: value,
        ...
        on: {
          change: function change(stepper, newValue) {
            (0, _utils.emit)(props, 'stepperChange', newValue);
          }
        }
      }));
    });
  ...
  if (input && !buttonsOnly) {
    ...
    inputWrapEl = /*#__PURE__*/_react.default.createElement("div", {
      className: "stepper-input-wrap"
    }, inputEl);
  }

  if (!input && !buttonsOnly) {
    valueEl = /*#__PURE__*/_react.default.createElement("div", {
      className: "stepper-value"
    }, value);
  }

  var classes = (0, _utils.classNames)(className, 'stepper', {
    disabled: disabled,
    'stepper-round': round,
  ...
  }), inputWrapEl, valueEl, /*#__PURE__*/_react.default.createElement("div", {
